...
# session.add(lukasz_nowicki)


# commit our fisrt session to othe database
session.commit()
...
if programmer is not None:
    ...
    confirmation = input("Are you sure you w3ant to delete this record? (y/n)")
